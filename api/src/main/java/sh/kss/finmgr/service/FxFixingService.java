...
public interface FxFixingService {

    void saveAll(Collection<FxFixing> fxFixings);

    Optional<FxFixing> find(FxFixingKey key);
    Optional<FxFixing> findNearest(FxFixingKey key);
}